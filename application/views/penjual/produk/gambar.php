...
//Form open
echo form_open_multipart(base_url('penjual/produk/gambar/' . $produk->id_produk), ' class="form-horizontal"');
?>
    ...
    <tbody>
        ...
        foreach ($gambar as $gambar) { ?>
            <tr>
                ...
                <td>
                    <a href="<?= base_url('penjual/produk/delete_gambar/' . $produk->id_produk . '/' . $gambar->id_gambar) ?>" class="btn btn-danger btn-xs" onclick="return confirm('Apakah anda yakin menghapus gambar ini?')"><i class="fa fa-trash-o"></i> Hapus</a>
                </td>
            </tr>
        <?php $no++;
        } ?>
