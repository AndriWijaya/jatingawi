<p class="pull-right">
    <div class="btn-group pull-right">
        <a href="<?= base_url('penjual/transaksi/cetak/' . $header_transaksi->kode_transaksi) ?>" target="_blank" title="Cetak" class="btn btn-success btn-sm"><i class="fa fa-print"></i> Cetak</a>
        <a href="<?= base_url('penjual/transaksi') ?>" title="Kembali" class="btn btn-info btn-sm"><i class="fa fa-backward"></i> Kembali</a>
    </div>
</p>
