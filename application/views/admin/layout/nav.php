...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <!-- Menu Transaksi -->
      <li><a href="<?= base_url('admin/transaksi') ?>"><i class="fa fa-check text-aqua"></i> <span>TRANSAKSI</span></a></li>
      ...
      <!-- Menu Dashboard -->
      <li><a href="<?= base_url('admin/rekening') ?>"><i class="fa fa-dollar text-aqua"></i> <span>DATA REKENING</span></a></li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li><a href="<?= base_url('admin/konfigurasi/icon') ?>"><i class="fa fa-desktop "></i> Konfigurasi Icon</a></li>
        </ul>
      </li>
